...
namespace PrancaBeauty.WebApp.Authentication
{
    public class Roles
    {
        ...
        #region ShowcaseTabSection
        public const string CanViewListShowcaseTabSections = "CanViewListShowcaseTabSections";
        public const string CanAddShowcaseTabSection = "CanAddShowcaseTabSection";
        public const string CanEditShowcaseTabSection = "CanEditShowcaseTabSection";
        public const string CanRemoveShowcaseTabSection = "CanRemoveShowcaseTabSection";
        #endregion

        #region ShowcaseTabSectionItem
        public const string CanViewListShowcaseTabSectionItems = "CanViewListShowcaseTabSectionItems";
        public const string CanAddShowcaseTabSectionItem = "CanAddShowcaseTabSectionItem";
        public const string CanEditShowcaseTabSectionItem = "CanEditShowcaseTabSectionItem";
        public const string CanRemoveShowcaseTabSectionItem = "CanRemoveShowcaseTabSectionItem";
        #endregion

        #region Bills
        public const string CanViewListBillAdmin = "CanViewListBillAdmin";
        public const string CanViewListBillSeller = "CanViewListBillSeller";
        public const string CanChangeBillStatus = "CanChangeBillStatus";
        public const string CanChangeBillStatusForAll = "CanChangeBillStatusForAll";
