...
namespace PrancaBeauty.WebApp.Pages.Admin.Showcases.Tabs.TabSections.SectionItems.Edit
{
    ...
    public class EditSectionKeywordItemModel : PageModel
    {
        ...
        public EditSectionKeywordItemModel(ILogger logger, IMsgBox msgBox, IMapper mapper, ILocalizer localizer, IServiceProvider serviceProvider, ILanguageApplication languageApplication, IShowcaseTabSectionItemApplication showcaseTabSectionItemApplication)
        {
            _Logger=logger;
            _MsgBox=msgBox;
            _Mapper=mapper;
        ...
        public async Task<IActionResult> OnGetAsync(viGetEditSectionKeywordItem Input, string ReturnUrl = null)
        {
            try
            {
                #region validations
                ...
                var qData = await _ShowcaseTabSectionItemApplication.GetKeywordItemForEditAsync(new InpGetKeywordItemForEdit { SectionItemId=Input.SectionItemId });
                this.Input = _Mapper.Map<viEditSectionKeywordItem>(qData);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                var _MappedData = _Mapper.Map<InpSaveEditKeywordItem>(Input);

                var _Result = await _ShowcaseTabSectionItemApplication.SaveEditKeywordItemAsync(_MappedData);
        ...
        [BindProperty]
        public viEditSectionKeywordItem Input { get; set; }
    }
}
