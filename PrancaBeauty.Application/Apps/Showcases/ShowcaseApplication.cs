                                                                                    ...
                                                                                    LstSectionItem= c.tblShowcaseTabSectionItems
                                                                                                        .Select(d => new OutGetItemsForMainPageShowcase_SectionItem
                                                                                                        {
                                                                                                            ...
                                                                                                            ProductItem= d.SectionType==TabSectionItemsEnum.Product ? new OutGetItemsForMainPageShowcase_SectionProductItem
                                                                                                            {
                                                                                                                ...
                                                                                                                SellerPercent= d.tblSectionProducts.tblProducts.tblProductVariantItems.Where(d => d.IsEnable && d.IsConfirm && d.CountInStock>0).Select(e => new { SellerPercent = e.Percent - e.tblProductDiscounts.Percent, Percent = e.Percent }).OrderBy(e => e.SellerPercent).FirstOrDefault().Percent,
                                                                                                                PercentSavePrice= d.tblSectionProducts.tblProducts.tblProductVariantItems.Where(d => d.IsEnable && d.IsConfirm && d.CountInStock>0).Select(e => new { SellerPercent = e.Percent - e.tblProductDiscounts.Percent, SavePercent = e.tblProductDiscounts.Percent }).OrderBy(e => e.SellerPercent).FirstOrDefault().SavePercent,
                                                                                                            ...
                                                                                                            CategoryItems= d.SectionType==TabSectionItemsEnum.Category ? d.tblSectionProductCategory.tblCategory.tblProducts.Where(e => e.IsConfirmed)
                                                                                                                            ...
                                                                                                                            .IfThenElse(d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Oldest, e => e.OrderBy(e => e.Date), null)
                                                                                                                            .IfThenElse(d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Popular, e => e.OrderByDescending(e => e.tblProductReviews.Average(f => f.CountStar)), null)
                                                                                                                            .Select(e => new OutGetItemsForMainPageShowcase_SectionProductItem
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                SellerPercent= e.tblProductVariantItems.Where(d => d.IsEnable && d.IsConfirm && d.CountInStock>0).Select(f => new { SellerPercent = f.Percent - f.tblProductDiscounts.Percent, Percent = f.Percent }).OrderBy(f => f.SellerPercent).FirstOrDefault().Percent,
                                                                                                                                PercentSavePrice= e.tblProductVariantItems.Where(d => d.IsEnable && d.IsConfirm && d.CountInStock>0).Select(f => new { SellerPercent = f.Percent - f.tblProductDiscounts.Percent, SavePercent = f.tblProductDiscounts.Percent }).OrderBy(f => f.SellerPercent).FirstOrDefault().SavePercent,
                                                                                                                                IsInBookmark=false,// TODO: Create Bookmark Table
                                                                                                            ...
                                                                                                            KeywordItems= d.SectionType==TabSectionItemsEnum.Keyword ? d.tblSectionProductKeyword.tblKeywords.tblKeywords_Products.Where(e => e.tblProducts.IsConfirmed)
                                                                                                                            ...
                                                                                                                            .IfThenElse(d.tblSectionProductKeyword.OrderBy==tblSectionProductKeywordOrderByEnum.Oldest, e => e.OrderBy(e => e.tblProducts.Date), null)
                                                                                                                            .IfThenElse(d.tblSectionProductKeyword.OrderBy==tblSectionProductKeywordOrderByEnum.Popular, e => e.OrderByDescending(e => e.tblProducts.tblProductReviews.Average(f => f.CountStar)), null)
                                                                                                                            .Select(e => new OutGetItemsForMainPageShowcase_SectionProductItem
                                                                                                                            {
