                                                                                    ...
                                                                                    LstSectionItem= c.tblShowcaseTabSectionItems
                                                                                                        .Select(d => new OutGetItemsForMainPageShowcase_SectionItem
                                                                                                        {
                                                                                                            ...
                                                                                                            CategoryItems= d.SectionType==TabSectionItemsEnum.Category ? d.tblSectionProductCategory.tblCategory.tblProducts.Where(e => e.IsConfirmed)
                                                                                                                            ...
                                                                                                                            .OrderByDescending(e=> d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Oldest? e.Date:default)
                                                                                                                            .OrderByDescending(e=> d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Popular? e.tblProductReviews.Average(f => f.CountStar) : default)
                                                                                                            ...
                                                                                                            KeywordItems= d.SectionType==TabSectionItemsEnum.Keyword ? d.tblSectionProductKeyword.tblKeywords.tblKeywords_Products.Where(e => e.tblProducts.IsConfirmed)
                                                                                                                            .OrderBy(e => d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Newest ? e.tblProducts.Date : default)
                                                                                                                            .OrderByDescending(e => d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Oldest ? e.tblProducts.Date : default)
                                                                                                                            .OrderByDescending(e => d.tblSectionProductCategory.OrderBy==tblSectionProductCategoryOrderByEnum.Popular ? e.tblProducts.tblProductReviews.Average(f => f.CountStar) : default)
                                                                                                                            .Select(e => new OutGetItemsForMainPageShowcase_SectionProductItem
                                                                                                                            {
