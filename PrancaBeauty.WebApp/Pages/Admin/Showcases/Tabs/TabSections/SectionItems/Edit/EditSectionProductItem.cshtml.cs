...
namespace PrancaBeauty.WebApp.Pages.Admin.Showcases.Tabs.TabSections.SectionItems.Edit
{
    ...
    public class EditSectionProductItemModel : PageModel
    {
        ...
        public EditSectionProductItemModel(ILogger logger, IMsgBox msgBox, IMapper mapper, ILocalizer localizer, IServiceProvider serviceProvider, ILanguageApplication languageApplication, IShowcaseTabSectionItemApplication showcaseTabSectionItemApplication)
        {
            _Logger=logger;
            _MsgBox=msgBox;
            _Mapper=mapper;
        ...
        public async Task<IActionResult> OnGetAsync(viGetEditSectionProductItem Input, string ReturnUrl = null)
        {
            try
            {
                #region validations
                ...
                var qData = await _ShowcaseTabSectionItemApplication.GetProductItemForEditAsync(new InpGetProductItemForEdit { SectionItemId=Input.SectionItemId });
                this.Input = _Mapper.Map<viEditSectionProductItem>(qData);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                var _MappedData = _Mapper.Map<InpSaveEditProductItem>(Input);

                var _Result = await _ShowcaseTabSectionItemApplication.SaveEditProductItemAsync(_MappedData);
        ...
        [BindProperty]
        public viEditSectionProductItem Input { get; set; }
    }
}
