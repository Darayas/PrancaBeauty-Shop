...
namespace PrancaBeauty.WebApp.Models.ViewInput
{
    public class viEditProduct
    {
        ...
        public List<viEditProduct_Properties> Properties { get; set; }

        [Display(Name = "Keywords")]
        public List<viEditProduct_Keywords> Keywords { get; set; }

        [Display(Name = "ProductVariants")]
        public List<viEditProduct_Variants> Variants { get; set; }

        [Display(Name = "PostingRestrictions")]
        public List<viEditProduct_PostingRestrictions> PostingRestrictions { get; set; }
    }

    public class viEditProduct_Properties
    {
    ...
    public class viEditProduct_Keywords
    {
    ...
    public class viEditProduct_PostingRestrictions
    {
