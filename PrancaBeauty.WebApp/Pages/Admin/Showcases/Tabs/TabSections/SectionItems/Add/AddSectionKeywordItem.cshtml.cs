...
namespace PrancaBeauty.WebApp.Pages.Admin.Showcases.Tabs.TabSections.SectionItems.Add
{
    ...
    public class AddSectionKeywordItemModel : PageModel
    {
        ...
        public AddSectionKeywordItemModel(ILogger logger, IMsgBox msgBox, IMapper mapper, ILocalizer localizer, IServiceProvider serviceProvider, IShowcaseTabSectionItemApplication showcaseTabSectionItemApplication)
        {
            _Logger=logger;
            _MsgBox=msgBox;
            _Mapper=mapper;
        ...
        public IActionResult OnGet(viGetAddSectionKeywordItem Input, string ReturnUrl = null)
        {
            try
            {
                #region validations
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                var _MappedData = _Mapper.Map<InpAddTabSectionKeywordItem>(Input);

                var _Result = await _ShowcaseTabSectionItemApplication.AddTabSectionKeywordItemAsync(_MappedData);
        ...
        [BindProperty]
        public viAddSectionKeywordItem Input { get; set; }
    }
}
